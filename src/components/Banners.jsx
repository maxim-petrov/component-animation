...
const Banner = ({ id, title, subtitle, index }) => {
  return (
    <div 
      className="card-banner-f1b-0-0-4 card-medium-cfd-0-0-4 card-primary-c1a-0-0-4 card-clickable-77a-0-0-4 aMRDQ wOzPG animated-banner" 
      data-e2e-id={`banner-${id}`}
    >
      <div className="card-icon-236-0-0-4">
        <div className="icon-root-864-6-0-3 banner-icon">
...
const Banners = () => {
  ...
  return (
    <div className="QIMpV banner-container">
